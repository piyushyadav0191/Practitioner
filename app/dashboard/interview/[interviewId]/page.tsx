...
import { ParticularInterviewDataResponse } from '@/types/main'
...
const InterviewPage =  ({params}: InterviewPageProps) => {
  ...
  const [interviewData, setInterviewData] = React.useState<ParticularInterviewDataResponse>()
  ...
  return (
    ...
    <div className='flex flex-col my-5 gap-4'>
     ...
     <h2>Enable Video Web Cam and Microphone to Start your AI Generated Practitioner Interview, It has 5 Questions which you can answer and at the last you will get the report on the basis of your answer. NOTEE: We never record your video, Web Cam access you can disable it at any time if you want</h2>
      </div>
    </div>
    </div>
